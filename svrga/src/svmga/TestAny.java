...
public class TestAny {
	...
	public static void main(String[] args) {
		...
		try {
			...
			File result0 = new File(prefix+"mlr_x.txt");
			File result1 = new File(prefix+"mlr_quar.txt");
			File result2 = new File(prefix+"mlr_rosen.txt");
			File result3 = new File(prefix+"mlr_step.txt");
			File result4 = new File(prefix+"mlr_sch.txt");
			File result5 = new File(prefix+"mlr_cos.txt");
			File result6 = new File(prefix+"mlr_ackley.txt");
			File result7 = new File(prefix+"mlr_gri.txt");
			File result8 = new File(prefix+"mlr_pen1.txt");
			File result9 = new File(prefix+"mlr_pen2.txt");
			File result10 = new File(prefix+"mlr_non.txt");
			File result11 = new File(prefix+"mlr_wei.txt");
...
//            	a1.Calculate(200, 40, 30, scopes100, new QuardircMaxFunction(), percent, gamma, c, output[1]);
//            	a1.Calculate(200, 40, 30, scopes30, new RosenbrockMaxFunction(), percent, gamma, c, output[2]);
//            	a1.Calculate(200, 40, 30, scopes100, new StepMaxFunction(), percent, gamma, c, output[3]);
//            	a1.Calculate(200, 40, 30, scopes500, new SchwefelMaxFunction(), percent, gamma, c, output[4]);
//            	a1.Calculate(200, 40, 30, scopes512, new CosMaxFunction(), percent, gamma, c, output[5]);
//            	a1.Calculate(200, 40, 30, scopes32, new AckleyMaxFunction(), percent, gamma, c, output[6]);
...
//            	a1.Calculate(200, 40, 30, scopes5, new NonMaxFunction(), percent, gamma, c, output[10]);
//            	a1.Calculate(200, 40, 30, scopes512, new WeiMaxFunction(), percent, gamma, c, output[11]);
