...
public class Genotype
  ...
  public synchronized void evolve(BPNNGA obj,  FitnessFunction fitness, int percent,  BufferedWriter output) {
	    IBreeder breeder = getConfiguration().getBreeder();
	    Population newPop = breeder.evolve(getPopulation(), getConfiguration(), obj, fitness, percent, output);
	    setPopulation(newPop);
	  }
